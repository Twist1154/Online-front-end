...
import { getProductsCreatedAfter } from "../services/ProductService.js";

export default function ProductName() {
    const [productCreated, setProductCreated] = React.useState('');
    const [products, setProducts] = React.useState([]); // Stores fetched products as an array
    const [error, setError] = React.useState(null);

    const handleFetchProduct = async () => {
        try {
            const response = await getProductsCreatedAfter(productCreated);
    ...
    const handleProductCreatedChange = (event) => {
        setProductCreated(event.target.value);
    };
        ...
        <div>
            <Box>
                <TextField
                    ...
                    onChange={handleProductCreatedChange}
                    margin="normal"
                />
                <Button
                    variant="contained"
